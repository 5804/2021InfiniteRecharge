...
public class DriveForward12Feet extends SequentialCommandGroup {
  /** Creates a new BarrelRacingPath. */
  public DriveForward12Feet(DriveTrainSubsystem driveTrainSubsystem, IntakeSubsystem intakeSubsystem) {

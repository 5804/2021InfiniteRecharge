...
public class GalacticSearchBRed extends ParallelCommandGroup {
  /** Creates a new GalacticSearchBRed. */
  public GalacticSearchBRed(DriveTrainSubsystem driveTrainSubsystem, IntakeSubsystem intakeSubsystem) {

    String trajectoryJSON = "paths/redPathGalacticPathB.wpilib.json";
